...
<body>
    ...
    <form method="post" class="col-lg-4 mx-auto position-absolute top-50 start-50 translate-middle">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="data1" id="data1" value="<?= $data['data1'] ?>" autocomplete="off" class="form-control">
            </div>
        </div>
        <div class="row mb-3">
            <label for="data2" class="col-sm-2 col-form-label">Data 2 : </label>
            <div class="col-sm-10">
                <input type="text" name="data2" id="data2" value="<?= $data['data2'] ?>" autocomplete="off" class="form-control">
            </div>
        </div>
        <div class="row mb-3">
            <label for="data3" class="col-sm-2 col-form-label">Data 3 : </label>
            <div class="col-sm-10">
                <input type="text" name="data3" id="data3" value="<?= $data['data3'] ?>" autocomplete="off" class="form-control">
            </div>
        </div>
